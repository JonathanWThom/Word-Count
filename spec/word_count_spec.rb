...
describe('String#word_count') do
  ...
  it('User can input a target word or string in either upper or lowercase (or a mix) and and will be returned how many times the target word appears in the string as a full word') do
    expect('peCk'.word_count('If Peter Piper picked a Peck of pickled peppers, where\'s the pecK of pickled peppers Peter Piper picked?')).to(eq(2))
  end
end
